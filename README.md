...
```bash
docker network create "nome-de-sua-rede"
```
...
### 4. Verifique o IP do `zabbix-agent`
...
No exemplo acima, o IP do `zabbix-agent` seria `172.18.0.5`.

### 5. Adicione o IP do `zabbix-agent` na interface web
...
### 6. Acesse a interface web do Zabbix
